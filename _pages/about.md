...
My research interest Audio-visual speech processing, includes (audio-only or audio-visual) speaker recognition, speaker diarization, speech extraction, active speaker detection, self-supervised learning. I have published more than 10 papers at the top international AI conferences and journals such as NeurIPS, TASLP, ICASSP, INTERSPEECH. <a href='https://scholar.google.com/citations?hl=en&user=1W24GsQAAAAJ'>
  <img src="https://img.shields.io/endpoint?url=https://yourapi.example.com/scholar_citations&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&label=citations">
</a>
